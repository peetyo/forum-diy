...
class Route {
    ...
    public static $validRoutes = array('index.php', 'category', 'sign-up', 'verify', 'create-user', 'login', 'topic', 'error', 'logout', 'create-topic', 'api-create-topic', 'edit-topic', 'api-edit-topic');
